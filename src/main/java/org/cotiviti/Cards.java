    ...
    public static void main(String[] args) {
        ...
        if (numPlayers > 0 && numPlayers <= 17) {
            ...
            for (int i = 0; i < numPlayers * cardsPerPlayer; i++) {
             ...
             List<List<String>> myHands = List.of(
...
//             myGame.checkTrail(playersList, trailPlayersList, myHands, my_game, ranks, playersCount);
//             myGame.checkDoubleRun(playersList, doubleRunPlayersList, myHands, my_game, ranks, playersCount);
//             myGame.checkRun(playersList, runPlayersList, myHands, my_game, ranks, playersCount);
//             myGame.checkColor(playersList, colorPlayersList, myHands, my_game, ranks, playersCount);
//             myGame.checkPair(playersList, pairPlayersList, myHands, my_game, playersCount);
//             myGame.defaultHand(playersList, nothingPlayersList, myHands, my_game, ranks, playersCount);
//             System.out.println("-----------------------------");
            myGame.checkTrail(
                    playersList,
                    trailPlayersList,
            ...
            for (Players player : playersList) {
                if (my_game.getTrail() > 0 && player.getStatus().equals("Trail")) {
                    if (my_game.getTrail() == 1) {
                        ...
                        my_game.getDoubleRun() > 0 && player.getStatus().equals("Double Run")
                ) {
                ...
                } else if (my_game.getRun() > 0 && player.getStatus().equals("Run")) {
                    if (my_game.getRun() == 1) {
                        player.setState("Winner");
                        my_game.setWinner(player);
                        break;
                ...
                } else if (my_game.getColor() > 0 && player.getStatus().equals("Color")) {
                ...
                } else if (my_game.getPair() > 0 && player.getStatus().equals("Pair")) {
                ...
                } else if (my_game.getNothing() > 0 && player.getStatus().equals("Power")) {
    ...
    public String[] sortFunc(
        ...
        for (String card : playersHand) {
            ...
            hand[ind] = card.substring(0, index);
            ind++;
        }
    ...
    public void checkTrail(
        ...
        for (int i = 0; i < numPlayers; i++) {
            boolean trail = true;
            int index1 = myHands.get(i).get(0).indexOf(" ");
            String num = myHands.get(i).get(0).substring(0, index1);

            String[] myHand = sortFunc(myHands.get(i), ranks);

            for (String card : myHands.get(i)) {
                int index = card.indexOf(" ");
    ...
    public void checkDoubleRun(
        ...
        for (int i = 0; i < numPlayers; i++) {
            ...
            int index1 = myHands.get(i).get(0).lastIndexOf(" ");
            String num = myHands.get(i).get(0).substring(index1 + 1);
    ...
    public void checkPair(
        ...
        for (int i = 0; i < numPlayers; i++) {
            ...
            for (String mCard : myHands.get(i)) {
